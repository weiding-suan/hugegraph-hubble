...
import static com.baidu.hugegraph.options.HubbleOptions.UPLOAD_FILE_SIZE_SINGLE_LIMIT;
import static com.baidu.hugegraph.options.HubbleOptions.UPLOAD_FILE_SIZE_TOTAL_LIMIT;
...
public class HubbleMultipartResolver extends CommonsMultipartResolver {
    ...
    protected MultipartParsingResult parseRequest(HttpServletRequest request)
        ...
        fileUpload.setFileSizeMax(this.config.get(UPLOAD_FILE_SIZE_SINGLE_LIMIT) * Bytes.MB);
        fileUpload.setSizeMax(this.config.get(UPLOAD_FILE_SIZE_TOTAL_LIMIT) * Bytes.MB);
